---
title: 06. 代码重构：本地依赖共享与相对路径修复 | hachimi 教程
description: 本章详解在 Monorepo 开发中如何将共享工具抽取到独立包，解决 TS 模块相对路径引入报错与 package.json 本地依赖映射问题。
keywords: 代码重构, Monorepo 依赖, 共享工具, ESM 相对路径, @hachimi/shared, tsconfig 配置
---
