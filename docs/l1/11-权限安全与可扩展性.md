---
title: 11. 安全边界防御：工具执行风险分级与拦截审批 | hachimi 教程
description: 本章讲解在 Agent 调用敏感工具时如何进行防御性安全设计，包括显式白名单注册、权限风险分级（safe/dangerous）及人工确认拦截机制。
keywords: 安全边界, 权限设计, 人工审批, ToolPermission, 注入攻击防护, 阻断执行
---
