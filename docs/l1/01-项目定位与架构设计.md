---
title: 01. 项目定位与整体架构设计 | hachimi 教程
description: 本章讲解个人 AI 助理的架构设计思路，包括核心控制流、Harness 与 Channel 接入通道解耦，并提供清晰的 Mermaid 数据流时序图。
keywords: AI Agent, 整体架构, 时序图, 缰绳, Channel 适配, MVP 设计
---
